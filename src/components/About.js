    ...
    return (
        <div className="flex flex-col justify-center items-center bg-black py-6 pt-20 w-full">
            ...
            <div className="flex justify-center items-center space-x-6 p-6">
                <SocialIcon url="https://x.com/prathbhandari" network="twitter" target="_blank" fgColor="white" bgColor="transparent" />
                <SocialIcon url="https://www.instagram.com/prathamkrishnabhandari" network="instagram" target="_blank" fgColor="white" bgColor="transparent" />
                <SocialIcon url="https://www.youtube.com/@prathambhandari" network="youtube" target="_blank" fgColor="white" bgColor="transparent" />
                <SocialIcon url="https://github.com/prathambhandari" network="github" target="_blank" fgColor="white" bgColor="transparent" />
            </div>
        </div>
    );
}
