...
function Project (){
    return(
        <div className="flex flex-col justify-around h-auto items-center p-8 bg-black  ">
            <h1 className="text-4xl font-bold  mb-10 text-white">Projects</h1>
            
            <div className="bg-black  w-screen sm:w-screen md:w-screen lg:w-auto 2xl:w-auto p-5  grid grid-cols-1 grid-rows-2 gap-10 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 rounded-lg"> 
