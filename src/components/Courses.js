...
function Courses(){
    ...
    return(
        <div className="flex flex-col justify-around h-auto items-center py-12 bg-slate-100">
            <h1 className="text-4xl font-semibold  mb-5">Courses</h1>
         
           <div className="flex flex-wrap justify-around h-auto items-center p-4 bg-slate-100 gap-5">


            {/* Github */}

            <div className=" rounded-lg  bg-gradient-to-r from-slate-200 to-slate-300 w-72 h-72 p-6  flex flex-col justify-between cursor-pointer hover:from-slate-400 hover:to-slate-400 transition-transform">     
                <div>
