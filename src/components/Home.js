    ...
    render(){
        return(
            ...
            <div className="flex flex-col justify-center items-center bg-black  h-screen p-8 overflow-hidden">
                ...
                <h1 className="text-white w-auto font-bold p-10 z-20 text-5xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-4xl">{this.state.title}</h1> 
                <h2 className=" text-white flex justify-center py-3 font-sans z-20 w-96 text-lg sm:text-lg md:text-xl lg:text-xl 2xl:text-xl">Im Developer,</h2>
                <h1 className=" text-white flex justify-center py-3 font-bold z-20 w-96 text-2xl  sm:text-lg md:text-xl lg:text-xl 2xl:text-xl ">Courses ⬇️</h1>
